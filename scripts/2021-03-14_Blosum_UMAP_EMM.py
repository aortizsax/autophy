...
treeOR = dendropy.Tree.get(path=TREEPATH, schema="nexus", extract_comment_metadata=True)

ds = dendropy.DataSet.get_from_path(TREEPATH, "nexus", extract_comment_metadata=True)
