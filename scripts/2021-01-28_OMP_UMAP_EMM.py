...
TREEPATH = "../data/SPIKEtree/2021-01-24_SPIKE09_btsp50_MP.nwk"
OUTTREE = "../data/SPIKEtree/clustered/2021-01-31_SPIKE09_ML.nwk"
FAM = "SPIKE"
HEIGHT = 22

TREEPATH = "../data/SPIKEtree/2021-01-24_SPIKE09_btsp50_MP.nwk"
OUTTREE = "../data/SPIKEtree/clustered/2021-02-02_SPIKE09_MP.nwk"
FAM = "SPIKE"
HEIGHT = 22
...
# ##"2021_MP_OMP.nwk"
# OUTTREE = "../data/2021-02-02_ML_OMP.nwk"
# FAM = 'OMP'
# HEIGHT = 22
#
# =============================================================================
...
for n_H in n_Hs:
    ...
    plt.title("UMAP projection of the PDM dataset", fontsize=24)
    plt.show()
    ...
    BPcolors = [
        ...
        "red",
        "pink",
        "orange",  #'steelblue',#'cornflowerblue', 'turquoise', 'darkorange',
        "olive",
        "teal",
        "purple",
        "gold",
    ...
    for i, (mean, cov, color) in enumerate(
        ...
        if not np.any(Y_ == i):
            continue
        plt.scatter(X[Y_ == i, 0], X[Y_ == i, 1], 22, color=color, marker=".")
    ...
    ax.set_title("Selected GMM: full model, " + str(clf.n_components) + " components")
