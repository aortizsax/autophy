...
for n_H in n_Hs:
    ...
    plt.savefig('../data/EMMplots/2021-01-13_'+str(n_H)+'_GMMsweep_'+FAM+'_'+metric+'.png')
    plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 3}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-01-13_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
        plt.show()
