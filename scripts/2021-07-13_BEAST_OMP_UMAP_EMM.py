...
OUTTREE = (
    "../data/nextstraintrees/clustered/nextstrain_ncov_global_timetree_umapgmmem.nwk"
)
FAM = "nextstrain"
TREEID = "ncov"
HEIGHT = 22
...
for n_H in n_Hs:
    ...
    eteTree.render(
        "../data/" + FAM + "colored/2021-07-13" + FAM + TREEID + "_colored.png",
        w=183,
        units="mm",
        tree_style=ts,
        dpi=300,
