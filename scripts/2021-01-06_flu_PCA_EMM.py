# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 18:49:23 2021
...
plt.savefig("../data/2021-01-06_GMMsweepFlu.png")
plt.show()
...
k = 0
for v in catTax:  #######add check if |# isnt there
...
with plt.rc_context({"lines.linewidth": 3}):
    ...
    plt.savefig("../data/2021-01-06_EMClust_flu_coloredtree.png")
