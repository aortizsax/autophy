# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 17:09:41 2021
...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 17:04:20 2021
...
TREEPATH = "../../../../ChromeDownloads/nextstrain_ncov_global_timetree.nwk" 
...
N=3
reducer = umap.UMAP(n_cRONAonents=N)
...
ax.set_xlabel('Principal CRONAonent 1: ', fontsize = 15)#+str(round(pca.explained_variance_ratio_[0], 2))
ax.set_ylabel('Principal CRONAonent 2: ', fontsize = 15)#+str(round(pca.explained_variance_ratio_[1], 2))
ax.set_title('2 CRONAonent PCA', fontsize = 20)
...
ax.set_xlabel('Principal Component 1: ', fontsize = 15)#+str(round(pca.explained_variance_ratio_[0], 2))
ax.set_ylabel('Principal Component 2: ', fontsize = 15)#+str(round(pca.explained_variance_ratio_[1], 2))
...
plt.savefig('../data/2021-01-07_GMMsweepRONA.png')
plt.show()
...
with plt.rc_context({'lines.linewidth': 3}):
    ...
    plt.savefig("../data/2021-01-07_EMClust_RONA_coloredtree.png")
