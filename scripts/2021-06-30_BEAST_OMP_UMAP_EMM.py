...
# OUTTREE = "../data/BSHtree/clustered/2021-07-12_BSH_filterd_BEAST_umapemm.nwk"
# FAM = 'BSH'
# TREEID='A'
# HEIGHT = 22
# 
...
# OUTTREE = "../data/OMPtree/2021-07-12_OMPuniprot_muscle_umapemm.tree"
# TREEID='A'
# FAM = 'OMP'
# HEIGHT = 22
# =============================================================================
...
# # OUTTREE = "../data/viraltrees/2021-07-12_OMPuniprot_muscle_umapemm.tree"
# # TREEID='A'
# # FAM = 'viral'
# # HEIGHT = 22
# =============================================================================
...
OUTTREE = "../data/pfamtrees/clustered/2021-07-12_PF00067_seed_umapemm.tree"
TREEID='PF00067'
FAM = 'pfam'
HEIGHT = 22
...
# OUTTREE = "../data/controltrees/clustered/2021-07-12_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
# TREEID='acyltrans'
# FAM = 'control'
# HEIGHT = 22
# 
...
# OUTTREE = "../data/controltrees/clustered/2021-07-12_receptor-filtered-homo-muscle_umapemm.mean.tree"
# TREEID='receptor'
# FAM = 'control'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/controltrees/clustered/2021-07-12_uniprot-dehydrogenase-filtered-homo-muscleumapemm.1111.median.tree"
...
# =============================================================================
    ...
    plt.savefig('../data/EMMplots/2021-07-12_'+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.png')
    plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-07-12_"+str(n_H)+"_EMClust_"+FAM+TREEID+"_"+metric+"_coloredtree.png")
        plt.show()
...
# =============================================================================
    ...
    eteTree.render("../data/"+FAM+"colored/2021-07-12"+FAM+TREEID+"_colored.png",w=183,units='mm', tree_style=ts,dpi=300)
    ...
    OUTF="../data/"+FAM+"colored/2021-07-12"+FAM+TREEID+"_colored.csv"
    print(OUTF)
    import csv
