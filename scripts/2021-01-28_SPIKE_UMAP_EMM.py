# -*- coding: utf-8 -*-
"""
Created on Sun Jan 24 16:05:43 2021
...
OUTTREE = "../data/SPIKEtree/clustered/2021-01-28_SPIKE09_ML.nwk"
FAM = 'SPIKE'
HEIGHT = 22
...
# i += 1
# # =============================================================================
# # for node in treeOR.postorder_node_iter():#preorder_node_iter():    if node.label != None:
# #     if node.label != None:
...
#     plt.savefig('../data/EMMplots/2021-01-28_'+str(n_H)+'_GMMsweep_'+FAM+'_'+metric+'.png')
#     plt.show()
#     
...
#     k=0
#     for v in catTax:
#         print(v,BPcolors[k%len(BPcolors)])
#         if len(v)==1:
...
#         plt.savefig("../data/"+FAM+"colored/2021-01-28_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
#         plt.show()
# 
#     #make target vector
#     labs = []
...
#     ts.mode = "c"
#     ts.min_leaf_separation = 11
#     ts.optimal_scale_level = 11
#     print(dir(ts))
