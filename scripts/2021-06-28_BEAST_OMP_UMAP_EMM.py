...
OUTTREE = "../data/BSHtree/clustered/2021-06-17_BSH_filterd_BEAST_umapemm.nwk"
FAM = "BSH"
TREEID = "A"
HEIGHT = 22

TREEPATH = "../data/OMPtree/2021-06-16_OMPuniprot_muscle.tree"
OUTTREE = "../data/OMPtree/2021-06-17_OMPuniprot_muscle_umapemm.tree"
TREEID = "A"
FAM = "OMP"
HEIGHT = 22
...
# =============================================================================
# =============================================================================
# # TREEPATH = "../data/viraltrees/2021-03-21_OMPuniprot_muscle.tree"
# # OUTTREE = "../data/viraltrees/2021-06-17_OMPuniprot_muscle_umapemm.tree"
# # TREEID='A'
# # FAM = 'viral'
# # HEIGHT = 22
# =============================================================================
...
OUTTREE = "../data/controltrees/clustered/2021-06-22_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
TREEID = "acyltrans"
FAM = "control"
HEIGHT = 22
...
OUTTREE = "../data/controltrees/clustered/2021-06-22_receptor-filtered-homo-muscle_umapemm.mean.tree"
TREEID = "receptor"
FAM = "control"
HEIGHT = 22
...
# OUTTREE = "../data/controltrees/clustered/2021-06-22_uniprot-dehydrogenase-filtered-homo-muscleumapemm.1111.median.tree"
...
if (TREEPATH[-4:] == ".nhx") | (TREEPATH[-4:] == ".nwk"):
    treeOR = dendropy.Tree.get(
        path=TREEPATH, schema="newick", extract_comment_metadata=True
    )

    ds = dendropy.DataSet.get_from_path(
        TREEPATH, "newick", extract_comment_metadata=True
    )
else:
    treeOR = dendropy.Tree.get(
        path=TREEPATH, schema="nexus", extract_comment_metadata=True
    )

    ds = dendropy.DataSet.get_from_path(
        TREEPATH, "nexus", extract_comment_metadata=True
    )
...
for n_H in n_Hs:
    ...
    # =============================================================================
    if (FAM == "OMP") | (FAM == "nextstrain") | (FAM == "pfam") | (FAM == "control"):
        BPcolors = [
            "#e6194B",
            "#3cb44b",
            "#ffe119",
    ...
    eteTree.render(
        "../data/" + FAM + "colored/2021-06-28" + FAM + TREEID + "_colored.png",
        w=183,
        units="mm",
        tree_style=ts,
        dpi=300,
    ...
    OUTF = "../data/" + FAM + "colored/2021-06-28" + FAM + TREEID + "_colored.csv"
    print(OUTF)
    import csv
