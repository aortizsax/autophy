...
TREEPATH = "../data/pfamtrees/clustered/2021-06-20_PF00271_seed_umapemm.tree"
FAM = 'pfam'
HEIGHT = 22

ALNPATH = "../data/controlaln/2021-06-22_acyltransferase-filtered-homo-muscle.fasta"
TREEPATH ="../data/controltrees/clustered/2021-06-22_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
TREEID='acyltrans'
N=1000
FAM = 'control'
HEIGHT = 22
...
TREEPATH = "../data/controltrees/clustered/2021-06-22_receptor-filtered-homo-muscle_umapemm.mean.tree"
TREEID='receptor'
N=1289
FAM = 'control'
HEIGHT = 22
...
#'0': ['A', 'P', 'T'], '1': ['C', 'F', 'W', 'Y'], '2': ['D', 'E'], '3': ['I', 'L', 'M', 'V'], '4': ['H', 'K'], '5': ['R', 'Q'], '6': ['N', 'G', 'S']
    ...
    with open(ALNPATH,'r') as reader:
        for l in reader:
            ...
            if l[0] == '>':
                ...
                print(l)
                if FAM =='control':        
                    taxon = catDict[l.strip()[1:].split(" ")[0].replace('_','.')]
                else:
...
# for k,v in l:
# =============================================================================
OUTF="../data/"+FAM+"colored/2021-06-17"+FAM+TREEID+"_RF.csv"
print(OUTF)
print(l)
import csv
