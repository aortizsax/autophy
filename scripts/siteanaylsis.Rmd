...
for (n in unique(clades$Cluster))
  ...
  print(isClustLabel)
    ...
    if ( is.null(parentMRCA))
    {
      ...
      jpeg(file=paste('../data/',FAM,'colored/',FAM,'_clust_JSDiverg_',n,'_dt_05-31-2022.png',sep = ''))
      barplot(JSDclust,
             # border = "#69b3a2",
             col='darkgreen',
             xlab='Multiple Sequence Aligment position',
      ...
      svglite(file=paste('../data/',FAM,'colored/',FAM,'_clust_JSDiverg_',n,'_dt_05-31-2022.svg',sep = ''))
      barplot(JSDclust,
             # border = "#69b3a2",
             col='darkgreen',
             xlab='Multiple Sequence Aligment position',
      ...
      a<-ggplot() + 
        ...
        theme_logo()+scale_x_discrete(limits=grabbed)+
        annotate("text", x = pval.df$grabbed, y = 1.01, label = pval.df$sigcode)
      print(a)
      b<-a
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust',n,'_dt_05-31-2022b.svg',sep = ''),
            scale = 0.8,
            width = 25,
            height = 2.5)
      ...
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust_ancenstor',Node,'OF_',n,'_dt_05-31-2022b.svg',sep = ''),
            scale = 0.8,
            width = 25,
            height = 2.5)
      ...
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust_ancenstor',NodeC,'OF_',n,'_dt_05-31-2022b.svg',sep = ''),
            scale = 0.8,
            width = 25,
            height = 2.5)
    }    
