...
# OUTTREE = "../data/BSHtree/clustered/2022-04-21_BSH_filterd_BEAST_umapemm.nwk"
# Naln=417
# TREEID='mouse'
# FAM = 'BSH'
# HEIGHT = 22
...
# OUTTREE = "../data/viraltrees/clustered/2022-04-21_sarscov2sgly_umapemm.nwk"
# N = 1600
# FAM = 'viral'
# HEIGHT=25
# TREEID='sarscov2sgly'
...
# OUTTREE = "../data/viraltrees/clustered/2022-04-21_ebolasgly_umapemm.nwk"
# N = 1600
# FAM = 'viral'
# HEIGHT=25
# TREEID='ebolasgly'
...
# OUTTREE = "../data/controltrees/clustered/2022-04-21_uniprot-dehydrogenase-filtered-homo-muscleumapemm.1111.mean.tree"
...
# OUTTREE = "../data/controltrees/clustered/2022-04-21_receptor-filtered-homo-muscle_umapemm.mean.tree"
# TREEID='receptor'
# N=1289
# FAM = 'control'
# HEIGHT = 22
...
# OUTTREE = "../data/controltrees/clustered/2022-04-21_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
# TREEID='acyltrans'
# FAM = 'control'
# HEIGHT = 22
# Naln=1000
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF07690_seed_umapemm.tree"
# TREEID='PF07690'
# FAM = 'pfam'
# HEIGHT = 22
# 
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00528_seed_umapemm.tree"
# REP=' '
# TREEID='PF00528'
# FAM = 'pfam'
# HEIGHT = 22
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00501_seed_umapemm.tree"
# TREEID='PF00501'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00271_seed_umapemm.tree"
# TREEID='PF00271'
# FAM = 'pfam'
# HEIGHT = 44
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00072_seed_umapemm.tree"
# TREEID='PF00072'
# FAM = 'pfam'
# HEIGHT = 22
# 
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00069_seed_umapemm.tree"
# TREEID='PF00069'
# FAM = 'pfam'
# REP=' '
# HEIGHT = 22
...
# =============================================================================
# =============================================================================
# # ALNPATH = "../data/pfamaln/PF00267_full.txt"
# # TREEPATH = "../data/pfambeast/PF00267_full_1647740134882-nous.tree"
# # OUTTREE = "../data/pfamtrees/clustered/PF00267_full_umapemm.tree"
# # TREEID='PF00267'
# # FAM = 'pfam'
# # HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF00067_seed_umapemm.tree"
# TREEID='PF00067'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
# =============================================================================
# ALNPATH = "../data/pfamaln/PF07690_seed.txt"
# TREEPATH = "../data/pfamtrees/2021-06-18_PF07690_seed.tree"
# OUTTREE = "../data/pfamtrees/clustered/2022-04-21_PF07690_seed_umapemm.tree"
# TREEID='PF07690'
# FAM = 'pfam'
# HEIGHT = 22
...
# OUTTREE = "../data/panthertrees/2022-04-21_PTHR10010_aln.umapemm.tree" 
# TREEID='PTHR10010' 
# FAM = 'panther' 
# Naln=1116 
# HEIGHT = 22 
...
# OUTTREE = "../data/panthertrees/2022-04-21_PTHR10005_aln.umapemm.tree" 
# TREEID='PTHR10005' 
# FAM = 'panther' 
# Naln=2000 
# HEIGHT = 22 
...
# OUTTREE = "../data/panthertrees/2022-04-21_PTHR10000_aln.umapemm.tree" 
# TREEID='PTHR10000' 
# FAM = 'panther' 
# Naln=700 
# HEIGHT = 22 
...
# =============================================================================
# ALNPATH = '../data/pantheraln/2021-07-28_PTHR10037_aln.fasta' 
# TREEPATH = "../data/pantherbeast/2021-08-11_PTHR10037_aln.2211_cah_noeq.tree" 
# OUTTREE = "../data/panthertrees/2022-04-21_PTHR10037_aln.umapemm.tree" 
# TREEID='PTHR10037' 
# FAM = 'panther' 
# Naln=2000 
# HEIGHT = 22
...
# =============================================================================
# TREEPATH = "../data/nextstraintrees/2022-01-20_nextstrain_ncov_cladeanno.nwk"
# OUTTREE = "../data/nextstraintrees/2022-04-21_nextstrain_ncov_umapemm.tree"
# Naln=0
# TREEID='ncov'
# FAM = 'nextstrain'
# HEIGHT = 22
...
# =============================================================================
# =============================================================================
# TREEPATH = "../data/nextstraintrees/nextstrain_mumps_na_timetree.nwkk"
...
if (FAM == 'OMP')|(FAM == 'nextstrain')|(FAM == 'pfam')|(FAM == 'control')|(FAM == 'viral'):
    BPcolors = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#ba3fdf', '#42d4f4', 
                '#bfef45', '#fabed4', '#469990', '#dcbeff', '#9A6324', '#b3a400', '#800000', 
                '#82baff', '#808000', '#ffd8b1', '#0072B2',"#999999", "#E69F00", "#56B4E9", 
                "#009E73", "#F0E442", "#0072B2","#D55E00", "#CC79A7",'#f46d43',"#abd9e9"]
...
for n_H in n_Hs:
    ...
    plt.savefig('../data/EMMplots/2022-04-21_'+str(n_H)+'_ogUMAPprog'+FAM+TREEID+'_'+metric+'.svg',dpi=600,format='svg')
    ...
    for f in flag:
        ...
        while(len(f)>0):
            ...
            mp=True
            parentedge = leaf
            print("parentedge", leaf.description())#,dir(leaf))
            print('f',f)
            while(mp):
...
# =============================================================================
#                         print('result',res,descend,f)
# =============================================================================
                        if res > maxres:
                            parentedge = adj_edg
                            maxres=res
                            print('new max',res,descend)
                    ...
                    if check is True:
                        ...
                        for x in f:
                            ...
                            print(tmpf.index(x))
                            print(f.pop(f.index(x)),subclust)
...
# =============================================================================
    ...
    print((dictpred))
    times['str_replace'] = time.time()
    print("--- %s START to string change pass seconds ---" % (time.time() - start_time))
    ...
    plt.savefig('../data/EMMplots/2022-04-21_'+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.svg',dpi=600,format='svg')
    plt.show()

    OUTF="../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+"_colored_RF.csv"
    print(OUTF)
    import csv
        ...
        for k,v in dictpred.items():
            for val in v:
                ...
                if (TREEID == 'dehydrogenase'):
                    val = val.replace('_',' ')
                elif TREEID == 'receptor': #if tree viewer loads labels incorrectly
                    pass#val = val.replace('.','_')
                elif TREEID == 'acyltrans': #if tree viewer loads labels incorrectly
                    pass#val = val.replace('.','_')
    ...
    OUTF="../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+"_coloredPASSONE.csv"
    with open(OUTF,'w') as f :
        writer=csv.writer(f)
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2022-04-21_"+str(n_H)+"_EMClust_"+FAM+TREEID+"_"+metric+"_coloredtree.svg",format='svg',dpi=600)
        plt.show()
...
tree.ladderize()
Y_table = pd.read_csv("../data/"+FAM+"colored/2022-04-21"+
...
for mm in uniqueclust:
    ...
    if len(clusttaxon) > 1:
        ...
        pdmA = np.zeros((len(treeclust.taxon_namespace),len(treeclust.taxon_namespace)))
        counter = 0
        i = 0
        ...
        clustmpd = pdmclust.mean_pairwise_distance()
        print("Cluster:",mm,"; Tree Metric Log odds MPD",np.log10(clustmpd/totmpd))
        
        print("Cluster:",mm,"; Parent clade Metric Log odds MPD",np.log10(clustmpd/parclustmetric[mm]))
...
xs.append(np.random.normal(i + 1, 0.04, rankD[col].values.shape[0]))  # adds jitter to the data points - can be adjusted
...
plt.savefig("../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+"_subBAR_MPD.svg",
            format='svg')
plt.show()
...
for k in rankD.iterrows():
    clust = k[1]['Clust']
    color = k[1]['Color']    
    matplotlib.pyplot.annotate(k[1]['Clust'],
                               (k[1][x],
                                k[1][y]),
                               color = color,
                               size=18)
...
plt.savefig("../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+
...
plt.savefig("../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+"_sPASONEubBAR_MPD.svg",
            format='svg')
plt.show()
...
#     #         plt.title('Selected GMM: full model, '+ str(clf.n_components) +' Gaussian components')
#     #         plt.subplots_adjust(hspace=.35, bottom=.02)
#     #         plt.savefig('../data/EMMplots/2022-04-21_PASS2'+f2.split('|')[-1]+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.svg',dpi=600,format='svg')
#     #         plt.show()
#     #         
#     # =============================================================================
#             
...
# fig.savefig('../data/'+FAM+'colored/2022-04-21_'+FAM+TREEID+'_RFClassimportance.svg',dpi=600,format='svg')  
# fig.show()
# 
# 
# featdict = {}
...
# eteTree.render("../data/"+FAM+"colored/2022-04-21"+FAM+TREEID+"_colored.svg", tree_style=ts,dpi=600)
# 
#     
# 
# 
