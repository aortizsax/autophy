...
# =============================================================================
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-06-17_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
        plt.show()
...
# =============================================================================
    ...
    eteTree.render("../data/"+FAM+"colored/2021-06-17"+FAM+TREEID+"_colored.png",w=183,units='mm', tree_style=ts,dpi=300)
