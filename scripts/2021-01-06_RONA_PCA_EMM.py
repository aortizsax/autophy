# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 18:07:18 2021
...
for cv_type in cv_types:
    for n_components in n_components_range:
        ...
        gmm = mixture.GaussianMixture(
            n_components=n_components, random_state=111, covariance_type=cv_type
        )
        gmm.fit(X)
...
plt.savefig("../data/2021-01-06_GMMsweepRona.png")
plt.show()
...
with plt.rc_context({"lines.linewidth": 3}):
    ...
    fig = plt.figure(figsize=(8, 50), dpi=200)
    ...
    plt.savefig("../data/2021-01-06_EMClust_RONA_coloredtree.png")
