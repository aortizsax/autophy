...
for n_H in n_Hs:
    ...
    BPcolors = ["#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2",
                 "#D55E00", "#CC79A7",'#f46d43',"#abd9e9"]#COLORBLIND FRIENDLY
    
    BPcolors = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', 
                '#ba3fdf', '#42d4f4', '#bfef45', '#fabed4', '#469990', 
                '#dcbeff', '#9A6324', '#fffac8', '#800000', '#aaffc3', 
                '#808000', '#ffd8b1', '#0072B2'] 
    ...
    plt.savefig('../data/EMMplots/2021-06-15_'+str(n_H)+'_GMMsweep_'+metric+'.png')
    plt.show()
