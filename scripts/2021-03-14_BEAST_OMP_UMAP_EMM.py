...
OUTTREE = "../data/viraltrees/clustered/2021-06-07_sarscov2sgly_umapemm.nwk"
FAM = "viral"
HEIGHT = 22
...
#
# TREEPATH = "../data/viraltrees/sarscov2sgly_muscle_x_cah.tree"
# OUTTREE = "../data/sarscov2sgly_muscle_cah.nwk"
# FAM = 'viral'
# HEIGHT = 22
# =============================================================================

TREEPATH = "../data/BSHaln/2021-03-21_BSH_filtered_muscle_relaxed.tree"
OUTTREE = "../data/BSHtree/clustered/2021-06-07_BSH_filterd_BEAST_umapemm.nwk"
FAM = "BSH"
HEIGHT = 22

TREEPATH = "../data/OMPaln/2021-03-21_OMPuniprot_muscle.tree"
OUTTREE = "../data/OMPtree/2021-06-07_OMPuniprot_muscle_umapemm.tree"
FAM = "OMP"
HEIGHT = 22

TREEPATH = "../data/viraltrees/2021-03-21_OMPuniprot_muscle.tree"
OUTTREE = "../data/viraltrees/2021-06-07_OMPuniprot_muscle_umapemm.tree"
FAM = "viral"
HEIGHT = 22

TREEPATH = "../data/pfamtrees/PF00005_seed.tree"
...
for n_H in n_Hs:
    ...
    # =============================================================================
    if (FAM == "OMP") | (FAM == "nextstrain") | (FAM == "pfam"):
        BPcolors = [
            "#e6194B",
            "#3cb44b",
            "#ffe119",
    ...
    eteTree.render(
        "../data/06-07" + FAM + "colored/" + FAM + "_colored.png",
        w=183,
        units="mm",
        tree_style=ts,
        dpi=300,
