...
# =============================================================================
    ...
    plt.savefig('../data/EMMplots/2021-06-07_'+str(n_H)+'_GMMsweep_'+FAM+'_'+metric+'.png')
    plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-06-07_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
        plt.show()
...
# =============================================================================
    ...
    eteTree.render("../data/06-07"+FAM+"colored/"+FAM+"_colored.png",w=183,units='mm', tree_style=ts,dpi=300)
