...
for n_H in n_Hs:
    ...
    BPcolors = ['salmon','red','pink', 'orange',#'steelblue',#'cornflowerblue', 'turquoise', 'darkorange',
                ...
                'cyan','tan','green',
                'silver','maroon',
                'thistle','skyblue','plum','dodgerblue','chocolate','lime']#,'green','grey']
    ...
    plt.savefig('../data/EMMplots/2021-02-02_'+str(n_H)+'_GMMsweep_'+FAM+'_'+metric+'.png')
    plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 3}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-02-02_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
        plt.show()
