...
# # OUTTREE = "../data/SPIKEtree/clustered/2021-07-21_SPIKE09_ML.nwk"
# # FAM = 'SPIKE'
# # HEIGHT = 22
# # =============================================================================
# 
...
OUTTREE = "../data/BSHtree/clustered/2021-07-21_BSH_filterd_BEAST_umapemm.nwk"
FAM = 'BSH'
TREEID='A'
HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/OMPtree/2021-07-21_OMPuniprot_muscle_umapemm.tree"
# TREEID='A'
# FAM = 'OMP'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF07690_seed_umapemm.tree"
# TREEID='PF07690'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF00067_seed_umapemm.tree"
# TREEID='PF00067'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF00501_seed_umapemm.tree"
TREEID='PF00501'
FAM = 'pfam'
HEIGHT = 22

TREEPATH = "../data/pfamtrees/2021-07-15_PF00528_seed.1111.median.tree"
OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF00528_seed_umapemm.tree"
TREEID='PF00528'
FAM = 'pfam'
HEIGHT = 22

TREEPATH = "../data/pfamtrees/2021-07-15_PF00069_seed.1111.median.tree"
OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF00069_seed_umapemm.tree"
TREEID='PF00069'
FAM = 'pfam'
HEIGHT = 22

TREEPATH = "../data/pfamtrees/2021-07-15_PF00072_seed.1111.median.tree"
OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF00072_seed_umapemm.tree"
TREEID='PF00072'
FAM = 'pfam'
HEIGHT = 22
...
# OUTTREE = "../data/pfamtrees/clustered/2021-07-21_PF02518_seed_umapemm.tree"
# TREEID='PF02518'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/controltrees/clustered/2021-07-21_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
# TREEID='acyltrans'
# FAM = 'control'
# HEIGHT = 22
# 
...
# OUTTREE = "../data/controltrees/clustered/2021-07-21_receptor-filtered-homo-muscle_umapemm.mean.tree"
# TREEID='receptor'
# FAM = 'control'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/controltrees/clustered/2021-07-21_uniprot-dehydrogenase-filtered-homo-muscleumapemm.1111.median.tree"
...
# =============================================================================
    ...
    plt.savefig('../data/EMMplots/2021-07-21_'+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.tiff',dpi=300)
    plt.show()
    ...
    for i in range(0,len(taxons)):
        ...
        #monophylocheck 
        mplist[int(clf.predict(X)[i])].append(taxons[i])
...
# =============================================================================
    ...
    for f in flag:
        ...
        lowest_bic = np.infty
        bic = []
        n_components_range = range(1,len(v))
    ...
    # =============================================================================
        ...
        plt.ylim(min(X[:,1])-0.2,max(X[:,1])+0.2)
        plt.title('Selected GMM: full model, '+ str(clf.n_components) +' Gaussian components')
        plt.subplots_adjust(hspace=.35, bottom=.02)
        plt.savefig('../data/EMMplots/2021-07-21_reclust_'+str(reclustCount)+'_'+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.tiff',dpi=300)
        plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-07-21_"+str(n_H)+"_EMClust_"+FAM+TREEID+"_"+metric+"_coloredtree.tiff",dpi=300)
        plt.show()
...
#     eteTree.render("../data/"+FAM+"colored/2021-07-21"+FAM+TREEID+"_colored.tiff",w=183,units='mm', tree_style=ts,dpi=300)
# 
# 
# 
#     dictpred = {}
...
# 
#     OUTF="../data/"+FAM+"colored/2021-07-21"+FAM+TREEID+"_colored.csv"
#     print(OUTF)
#     import csv
