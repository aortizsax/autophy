...
for (n in unique(clades$Cluster))
  ...
  print(isClustLabel)
    ...
    if ( is.null(parentMRCA))
    {
      ...
      jpeg(file=paste('../data/',FAM,'colored/',FAM,'_clust_JSDiverg_',n,'_dt_06-01-2022.png',sep = ''))
      barplot(JSDclust,
             # border = "#69b3a2",
             col='darkgreen',
             xlab='Multiple Sequence Aligment position',
      ...
      svglite(file=paste('../data/',FAM,'colored/',FAM,'_clust_JSDiverg_',n,'_dt_06-01-2022.svg',sep = ''))
      barplot(JSDclust,
             # border = "#69b3a2",
             col='darkgreen',
             xlab='Multiple Sequence Aligment position',
      ...
      print(a)
      b<-a
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust',n,'_dt_06-01-2022.svg',sep = ''),
            scale = 0.3,
            width = 49,
            height = 5)
      ...
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust_ancenstor',Node,'OF_',n,'_dt_06-01-2022.svg',sep = ''),
            scale = 0.3,
            width = 49,
            height = 5)
      ...
      ggsave(paste('../data/',FAM,'colored/',FAM,'_clust_ancenstor',NodeC,'OF_',n,'_dt_06-01-2022.svg',sep = ''),
            scale = 0.3,
            width = 49,
            height = 5)
    }    
