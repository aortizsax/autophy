...
OUTTREE = "../data/2021-01-22_BSH_filterd_ML.nwk"
FAM = 'BSH'
HEIGHT = 22
...
n_Hs = [100]# [20,75,100,222]#[20,100,150,180,220,1000,2000,3000]
...
for n_H in n_Hs:
    ...
    BPcolors = ['navy',#'cornflowerblue', 'turquoise', 'darkorange',
                'olive','teal','purple','gold',
                                  'orange','salmon','red','cyan','tan','green',
                                  'silver','maroon','lime','pink']#,'green','grey']
    ...
    plt.savefig('../data/EMMplots/2021-01-22_'+str(n_H)+'_GMMsweep_'+FAM+'_'+metric+'.png')
    plt.show()
    ...
    with plt.rc_context({'lines.linewidth': 3}):
        ...
        plt.savefig("../data/"+FAM+"colored/2021-01-22_"+str(n_H)+"_EMClust_"+FAM+"_"+metric+"_coloredtree.png")
        plt.show()
