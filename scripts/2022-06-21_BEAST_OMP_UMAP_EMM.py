...
OUTTREE = "../data/BSHtree/clustered/2022-06-b22_BSH_filterd_BEAST_umapemm.nwk"
Naln = 417
TREEID = "mouse"
FAM = "BSH"
HEIGHT = 22
...
OUTTREE = "../data/controltrees/clustered/2022-06-b22_acyltransferase-filtered-homo-muscle_umapemm.1111.mean.tree"
TREEID = "acyltrans"
FAM = "control"
HEIGHT = 22
Naln = 1000
...
# OUTTREE = "../data/viraltrees/clustered/2022-06-b22_sarscov2sgly_umapemm.nwk"
# N = 1600
# FAM = 'viral'
# HEIGHT=25
# TREEID='sarscov2sgly'
...
# OUTTREE = "../data/viraltrees/clustered/2022-06-b22_ebolasgly_umapemm.nwk"
# N = 1600
# FAM = 'viral'
# HEIGHT=25
# TREEID='ebolasgly'
...
# =============================================================================
# ALNPATH= '../data/controlaln/2021-06-b22_uniprot-dehydrogenase-filtered-homo-muscle.fasta'
# TREEPATH = "../data/controltrees/2021-06-b22_uniprot-dehydrogenase-filtered-homo-muscle.1111.mean.tree"
# OUTTREE = "../data/controltrees/clustered/2022-06-b22_uniprot-dehydrogenase-filtered-homo-muscleumapemm.1111.mean.tree"
...
# =============================================================================
# ALNPATH = "../data/controlaln/2021-06-b22_receptor-filtered-homo-muscle.fasta"
# TREEPATH = "../data/controltrees/2021-06-b22_receptor-filtered-homo-musclecorr.median.tree"
# OUTTREE = "../data/controltrees/clustered/2022-06-b22_receptor-filtered-homo-muscle_umapemm.mean.tree"
# TREEID='receptor'
# N=1289
# FAM = 'control'
# HEIGHT = 22
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF07690_seed_umapemm.tree"
# TREEID='PF07690'
# FAM = 'pfam'
# HEIGHT = 22
#
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00528_seed_umapemm.tree"
# REP=' '
# TREEID='PF00528'
# FAM = 'pfam'
# HEIGHT = 22
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00501_seed_umapemm.tree"
# TREEID='PF00501'
# FAM = 'pfam'
# HEIGHT = 22
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00271_seed_umapemm.tree"
# TREEID='PF00271'
# FAM = 'pfam'
# HEIGHT = 44
# =============================================================================
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00072_seed_umapemm.tree"
# TREEID='PF00072'
# FAM = 'pfam'
# HEIGHT = 22
#
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00069_seed_umapemm.tree"
# TREEID='PF00069'
# FAM = 'pfam'
# REP=' '
# HEIGHT = 22
...
# OUTTREE = "../data/pfamtrees/clustered/2022-06-b22_PF00067_seed_umapemm.tree"
# TREEID='PF00067'
# FAM = 'pfam'
# HEIGHT = 22
#
...
# OUTTREE = "../data/panthertrees/2022-06-b22_PTHR10010_aln.umapemm.tree"
# TREEID='PTHR10010'
# FAM = 'panther'
# Naln=1116
# HEIGHT = 22
...
# OUTTREE = "../data/panthertrees/2022-06-b22_PTHR10005_aln.umapemm.tree"
# TREEID='PTHR10005'
# FAM = 'panther'
# Naln=2000
# HEIGHT = 22
...
# OUTTREE = "../data/panthertrees/2022-06-b22_PTHR10000_aln.umapemm.tree"
# TREEID='PTHR10000'
# FAM = 'panther'
# Naln=700
# HEIGHT = 22
...
# OUTTREE = "../data/panthertrees/2022-06-b22_PTHR10037_aln.umapemm.tree"
# TREEID='PTHR10037'
# FAM = 'panther'
# Naln=2000
# HEIGHT = 22
...
# OUTTREE = "../data/nextstraintrees/2022-06-b22_nextstrain_ncov_umapemm.tree"
# Naln=0
# TREEID='ncov'
# FAM = 'nextstrain'
# HEIGHT = 22
...
for n_H in n_Hs:
    ...
    OUTF = (
        "../data/" + FAM + "colored/2022-06-b22" + FAM + TREEID + "_coloredPASSONE.csv"
    )
    with open(OUTF, "w") as f:
        writer = csv.writer(f)
...
tree.ladderize()
Y_table = pd.read_csv(
    "../data/" + FAM + "colored/2022-06-b22" + FAM + TREEID + "_colored_RF.csv",
    dtype="string",
)
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-b22" + FAM + TREEID + "_subBAR_MPD.svg",
    format="svg",
)
plt.show()
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-b22" + FAM + TREEID + "_subpar_MPD_scatter.svg",
    format="svg",
)
plt.show()
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-b22" + FAM + TREEID + "_sPASONEubBAR_MPD.svg",
    format="svg",
)
plt.show()
