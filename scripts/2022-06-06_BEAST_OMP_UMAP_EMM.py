...
for n_H in n_Hs:
    ...
    OUTF = (
        "../data/" + FAM + "colored/2022-06-06" + FAM + TREEID + "_coloredPASSONE.csv"
    )
    with open(OUTF, "w") as f:
        writer = csv.writer(f)
...
tree.ladderize()
Y_table = pd.read_csv(
    "../data/" + FAM + "colored/2022-06-06" + FAM + TREEID + "_colored_RF.csv",
    dtype="string",
)
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-06" + FAM + TREEID + "_subBAR_MPD.svg",
    format="svg",
)
plt.show()
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-06" + FAM + TREEID + "_subpar_MPD_scatter.svg",
    format="svg",
)
plt.show()
...
plt.savefig(
    "../data/" + FAM + "colored/2022-06-06" + FAM + TREEID + "_sPASONEubBAR_MPD.svg",
    format="svg",
)
plt.show()
