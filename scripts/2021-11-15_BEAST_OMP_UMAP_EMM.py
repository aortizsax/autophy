...
# =============================================================================
    ...
    plt.savefig('../data/EMMplots/2022-01-11_'+str(n_H)+'_GMMsweep_'+FAM+TREEID+'_'+metric+'.svg',dpi=600,format='svg')
    plt.show()
    ...
    OUTF="../data/"+FAM+"colored/2022-01-11"+FAM+TREEID+"_coloredPASSONE.csv"
    import csv
    with open(OUTF,'w') as f :
        writer=csv.writer(f)
    ...
    with plt.rc_context({'lines.linewidth': 4}):
        ...
        plt.savefig("../data/"+FAM+"colored/2022-01-11_"+str(n_H)+"_EMClust_"+FAM+TREEID+"_"+metric+"_coloredtree.svg",format='svg',dpi=600)
        plt.show()
